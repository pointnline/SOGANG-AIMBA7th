...
export const RADAR_EVENTS: RadarEvent[] = [
  ...
  },
  {
    ...
    venue: "서울 (상세 비공개)",
    region: "서울",
    host: "Anthropic · BASS Ventures",
    price: "무료(등록마감)",
    priceType: "free",
    link: "https://luma.com/ht1jlnwy",
    linkType: "official",
    point: "Anthropic 직접 주관, Build 트랙(엔지니어링)·GTM 트랙 병행 — 취소표·대기 노릴 가치.",
    tier: 1,
    category: "빌드",
    verified: "link-ok",
    verifyNote: "등록 마감(Registration Closed) — 취소표 대기 또는 현장 입장 여부 불명",
    jjFlag: "weekday-work",
    curate: "pick",
  },
  {
    ...
    linkType: "community",
    point: "팀용 CLI 설계 + Edge-Cloud AI 운영 실사례 2세션 — 실무 밀도 높음. 신청 6/17 마감.",
    tier: 1,
    category: "개발",
    verified: "verified",
    jjFlag: "weekday-eve",
  ...
  // ───────────── TIER 2 · 빅테크/모델사 공식 ─────────────
  {
    ...
    linkType: "community",
    point: "OpenAI 팀 직접 참여 — 한국 사용자 피드백 수집 실험형 이벤트(오늘~내일 진행중).",
    tier: 2,
    category: "빅테크",
    verified: "verified",
    jjFlag: "weekend",
  ...
  },
  {
    ...
    linkType: "partner",
    point: "Claude 커뮤니티 × 래퍼 팔로알토 파이어사이드 — 'AI 시대 창작'의 인간 관점 탐색.",
    tier: 2,
    category: "빅테크",
    verified: "verified",
    jjFlag: "weekday-eve",
  ...
  // ───────────── TIER 3 · 투자/정책/산업/학술 ─────────────
  {
    ...
    point: "AI 에이전트 시대 거버넌스 15세션(금융·교육·안보·인권) — 정책 흐름 파악 필수 무료 컨퍼런스.",
    tier: 3,
    category: "정책",
    verified: "verified",
    jjFlag: "multi",
  ...
  },
  {
    ...
    linkType: "registration",
    point: "카카오·KT·LG CNS AI 에이전트 실무 사례 + AI 거버넌스 — 여의도 개최(이동 0). 등록 6/15 마감.",
    tier: 3,
    category: "산업",
    verified: "verified",
    verifyNote: "등록 마감 2026-06-15 23:59 — 사전 등록 필요",
    jjFlag: "weekday-work",
    curate: "pick",
  },
  {
    ...
    linkType: "official",
    point: "이스라엘 AI·딥테크 스타트업 5개사 — 해외 딥테크 투자 시그널 스캔. 사전등록 마감(현장 미확인).",
    tier: 3,
    category: "산업",
    verified: "verified",
    verifyNote: "사전등록 마감(6/12) — 현장 입장 가능 여부 별도 확인 필요",
    jjFlag: "weekday-work",
    curate: "watch",
  },
  {
    id: "dream-conference-ai-0620",
    title: "2026 꿈도 환승이 되나요 — 일하는 방식, AI로 환승하다",
    date: "2026-06-20",
    dateLabel: "2026-06-20(토) 10:00–17:00",
    venue: "서울 AI 허브(서울 AI Hub)",
    region: "서울",
    host: "AITY Korea · 여행가J(권정선)",
    price: "유료",
    priceType: "paid",
    link: "https://dream-2026-conference.vercel.app/",
    linkType: "official",
    point: "스타트업·아티스트·개발자 6인의 AI 협업 실전 케이스 — 도구 소개가 아닌 '일하는 방식' 전환 사례.",
    tier: 3,
    category: "산업",
    verified: "verified",
    jjFlag: "weekend",
  ...
  },
  {
    ...
    link: "https://icml.cc/",
    linkType: "official",
    point: "세계 3대 ML 학회가 서울 COEX 개최 — AI 최전선 연구 동향과 글로벌 네트워크 동시에.",
    tier: 3,
    category: "학술",
    verified: "verified",
    jjFlag: "multi",
  ...
  // ───────────── TIER 4 · 네트워킹 ─────────────
  {
    ...
    linkType: "registration",
    point: "마케터 30인 소규모 밋업 — AI 콘텐츠 제작 및 워크플로우 전환 실무 경험 공유.",
    tier: 4,
    category: "네트워킹",
    verified: "verified",
    jjFlag: "weekday-eve",
  ...
  },
  {
    ...
    category: "개발",
    verified: "verified",
    verifyNote: "참가 신청·회비 입금 마감 2026-06-21",
    jjFlag: "weekday-eve",
    curate: "watch",
  },
  {
  ...
  },
  {
    ...
    date: "2026-06-19",
    recurring: "매주 금 19:00~ (06-19 / 06-26 / 07-03 / 07-10)",
...
export const RADAR_META: RadarMeta = {
  ...
  baseDate: "2026-06-13",
  rangeDays: 30,
  source: "2026-06-13 /radar 풀스캔 — Luma·Meetup·Nextrise·Eventbrite·Onoffmix·AAAI·ICML·GlobalAI 수집, 전 링크 HTTP 200 검증 완료. 신규 3건(ICML·AWSKRUG데이터·꿈도환승) 추가, 과거 행사 8건 제거, 링크 2건 업데이트.",
