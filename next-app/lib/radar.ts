...
export const RADAR_EVENTS: RadarEvent[] = [
  ...
  {
    id: "ralphthon-icml-0705",
    title: "Ralphthon @ICML by Team Attention",
    date: "2026-07-05",
    dateLabel: "2026-07-05(일) 시간 미정",
    venue: "코엑스 인근, 서울",
    region: "서울",
    host: "Team Attention (ICML 2026 코로케이션)",
    price: "확인 필요",
    priceType: "unknown",
    link: "https://luma.com/7iiqamt2",
    linkType: "community",
    point: "에이전트 자율코딩(Ralph 루프) 해커톤 — 에이전트 오케스트레이션 실전. 딜 자동화 파이프라인 설계 힌트.",
    tier: 1,
    category: "빌드",
    verified: "link-ok",
    verifyNote: "RSVP 미오픈 — Road to ICML 허브 경유, 시간·장소 미정",
    jjFlag: "weekend",
    curate: "watch",
  },
  {
  ...
  {
    id: "vessl-icml-dinner-0706",
    title: "ICML Dinner with VESSL AI",
    date: "2026-07-06",
    dateLabel: "2026-07-06(월) 19:00–22:00",
    venue: "코엑스 인근, 서울",
    region: "서울",
    host: "VESSL AI",
    price: "확인 필요",
    priceType: "unknown",
    link: "https://luma.com/vessl-9xxv",
    linkType: "registration",
    point: "국내 MLOps 인프라사(VESSL AI) ICML 디너 — 모델 학습·서빙 인프라 현업자 네트워킹.",
    tier: 2,
    category: "빅테크",
    verified: "link-ok",
    verifyNote: "참가비·정원 등록 페이지 확인 권장",
    jjFlag: "weekday-eve",
    curate: "watch",
  },
  {
    id: "far-ai-open-social-0706",
    title: "FAR.AI Open Social in Seoul",
    date: "2026-07-06",
    dateLabel: "2026-07-06(월) 19:00–21:00",
    venue: "코엑스 인근, 서울",
    region: "서울",
    ...
    price: "확인 필요",
    priceType: "unknown",
    link: "https://luma.com/2z0dmzlp",
    linkType: "registration",
    point: "AI 안전·정렬 연구조직(FAR.AI) 오픈 소셜 — AI 거버넌스·리스크 관점 글로벌 연구자 접점.",
    tier: 2,
    category: "정책",
    verified: "link-ok",
    verifyNote: "참가비 등록 페이지 확인 권장",
  ...
  // ───────────── TIER 4 · 네트워킹 ─────────────
  {
    id: "trillion-frontier-night-0703",
    title: "Trillion Frontier Night x ICML 2026",
    date: "2026-07-03",
    dateLabel: "2026-07-03(금) 18:00~",
    venue: "코엑스 인근, 서울",
    region: "서울",
    host: "Trillion (ICML 2026 코로케이션)",
    price: "확인 필요",
    priceType: "unknown",
    link: "https://luma.com/7iiqamt2",
    linkType: "community",
    point: "프런티어 모델·스타트업 빌더 나이트 — ICML 첫날 저녁 글로벌 빌더·VC 네트워킹.",
    tier: 4,
    category: "네트워킹",
    verified: "link-ok",
    verifyNote: "등록 구글폼 — Road to ICML 허브 경유",
    jjFlag: "weekday-eve",
    curate: "watch",
  },
  {
  ...
  },
  {
    ...
    venue: "코엑스 인근, 서울",
    region: "서울",
    host: "MIT E14 Fund, Axiom (ICML 2026 코로케이션)",
    price: "확인 필요",
    priceType: "unknown",
    link: "https://luma.com/rmev9nn6",
    linkType: "registration",
    point: "MIT E14 Fund·Axiom 주최 애프터디너 — AI 딥테크 VC 네트워킹. 인수금융·PE 확장 관점 글로벌 투자자 접점.",
    tier: 4,
    category: "네트워킹",
    verified: "link-ok",
    verifyNote: "참가비 등록 페이지 확인 권장",
  ...
  },
  {
    ...
    linkType: "community",
    point: "AI·데이터·개발자 커뮤니티 애프터워크 네트워킹(매주 금요일 반복) — 글로벌 테크 인맥 확장. 7/12~7/29 윈도우 후반 유일 커버.",
    tier: 4,
    category: "네트워킹",
    verified: "verified",
    jjFlag: "weekday-eve",
